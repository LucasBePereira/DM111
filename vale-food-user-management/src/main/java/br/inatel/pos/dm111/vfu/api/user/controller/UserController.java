...
public class UserController {
    ...
    private UserResquestValidator validator;
    private final UserService service;

    public UserController(UserResquestValidator validator, UserService service) {
    ...
    @DeleteMapping(value = "/{userId}")
        public ResponseEntity<List<UserResponse>> deleteUser(@PathVariable("userId")String id)throws ApiException{
            log.debug("Received request to delete an user by id: {}", id);
    ...
    public ResponseEntity<UserResponse> putUser(@RequestBody UserRequest request,
        ...
        log.debug("Received request to update a new user...");
